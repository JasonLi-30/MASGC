...
def main():
    ...
    parser.add_argument(
        '--ann-file', type=str, default='/media/star/zjurobot/402/WYH_402/mmpose/data/h36m/annotation_body3d/fps10/h36m_test.npz')
    parser.add_argument(
        '--camera-param-file', type=str, default='/media/star/zjurobot/402/WYH_402/mmpose/data/h36m/annotation_body3d/cameras.pkl')
    parser.add_argument('--img-root', type=str, default='/media/star/zjurobot/402/WYH_402/mmpose/data/h36m/images/')
    parser.add_argument(
        '--out-file', type=str, default='/media/star/zjurobot/402/WYH_402/mmpose/data/h36m/annotation_body3d/fps10/h36m_coco_test.json')
    ...
    tasks = [(idx, ) + args + (h36m_camera_params, )
             for idx, args in enumerate(
                 zip(kpts_2d, kpts_3d, centers, scales, imgnames2))]
