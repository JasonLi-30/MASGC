...
def main():
    ...
    parser.add_argument(
        '--ann-file', type=str, default='/media/star/zjurobot/402/WYH_402/mmpose/data/h36m/annotation_body3d/fps10/h36m_train.npz')
    parser.add_argument(
    ...
    parser.add_argument(
        '--out-file', type=str, default='/media/star/zjurobot/402/WYH_402/mmpose/data/h36m/annotation_body3d/fps10/h36m_coco_train.json')
