...
class TopDownZJUHRIDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('configs/_base_/datasets/custom_wyh.py')
    ...
    def evaluate(self, results, res_folder=None, metric='mAP', **kwargs):
        ...
        for result in results:
            ...
            for i in range(batch_size):
                image_id = self.name2id[image_paths[i][len(self.img_prefix):]]  # wyh 9.9 mod
